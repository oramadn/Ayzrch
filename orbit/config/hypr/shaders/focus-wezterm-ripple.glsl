...
void main() {
    ...
    vec2 offset = direction * wave * envelope * 0.0036 * size_scale;

    float chroma = (front + edge_hit) * speed * 0.0018 * size_scale;
    ...
    colour *= 1.0 + effect_strength * 0.04;
    alpha = min(1.0, alpha + effect_strength * 0.08);
